...
type IRepository interface {
	...
	GetOne(ctx context.Context, queries map[string]interface{}) (*entity.Secret, error)
	GetList(ctx context.Context, queries map[string]interface{}) ([]*entity.Secret, error)
	GetListPaging(ctx context.Context, queries map[string]interface{}) ([]*entity.Secret, error)
	Count(ctx context.Context, queries map[string]interface{}) (int64, error)
